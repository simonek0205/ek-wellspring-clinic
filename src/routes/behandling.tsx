...
const vanligaBesvar = [
  {
    title: "Ländryggssmärta",
    text: "En av de vanligaste anledningarna att söka kiropraktor. Vi utreder orsaken – diskbesvär, facettledssmärta eller muskulära obalanser – och anpassar behandling med justering, mobilisering och övningar.",
  },
  {
    title: "Nackont och stelhet",
    text: "Ofta kopplat till stillasittande, stress eller dåliga sovställningar. Behandling kombinerar manuell terapi med rådgivning kring ergonomi och rörelse.",
  },
  {
    title: "Huvudvärk- och spänningshuvudvärk",
    text: "Många huvudvärksformer har sitt ursprung i nacken. Genom att behandla underliggande spänningar och ledrörlighet kan vi minska både intensitet och frekvens.",
  },
  {
    title: "Ischias och utstrålande smärta",
    text: "Smärta som strålar ner i benet kan ha flera orsaker. Vi gör en noggrann neurologisk bedömning och behandlar både nerver och omkringliggande strukturer.",
  },
  {
    title: "Axel- och skulderbesvär",
    text: "Impingement, Frozen shoulder eller överbelastning – vi utreder och behandlar tillsammans med riktad rehabträning.",
  },
  {
    title: "Höft- och knäbesvär",
    text: "Belastningsskador, artros och felställningar. Behandling som kombinerar mjukdelsarbete, ledjustering och stärkande övningar.",
  },
];

function BehandlingPage() {
  return (
    <>
      <PageHeader
        eyebrow="Behandling"
        title="Behandling anpassad efter dig"
        lead="Oavsett om du har akuta besvär, idrottsrelaterade skador eller vill arbeta förebyggande."
      />
      ...
      <section id="vanliga-besvar" className="py-20 scroll-mt-24">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <p className="text-muted-foreground max-w-2xl leading-relaxed mb-12">
            ...
            Här är några av de vanligaste tillstånden vi behandlar dagligen.
          </p>
        ...
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              ...
              dig att prestera optimalt, återhämta dig snabbare och minska risken för skador.
            </p>
            <p className="mt-4 text-foreground/80 leading-relaxed">
              Genom att hålla rörelseapparaten i balans skapar vi förutsättningar för bättre
              rörelsemönster, kraftöverföring och kroppskontroll – oavsett om du tränar på elitnivå
              eller motionerar regelbundet.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <p className="text-foreground/80 leading-relaxed text-lg">
              ...
              kiropraktik och massage kan fungera förebyggande genom att hålla kroppen i balans,
              motverka stelhet och fånga upp obalanser i tid.
            </p>
            <p className="mt-4 text-foreground/80 leading-relaxed">
              Tillsammans lägger vi upp en plan som passar din vardag, ditt arbete och dina mål – så
              att kroppen får förutsättningar att fungera bra över tid.
            </p>
          </div>
        </div>
      </section>
