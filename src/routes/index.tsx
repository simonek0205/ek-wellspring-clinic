  ...
  return (
    <>
      ...
      <section className="relative bg-navy text-cream overflow-hidden">
        ...
        <svg
          className="pointer-events-none absolute top-10 right-10 w-32 h-32 text-gold/30"
          viewBox="0 0 100 100"
          fill="none"
          stroke="currentColor"
          strokeWidth="0.5"
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-36 grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="uppercase tracking-[0.3em] text-xs text-cream/60 mb-5">
              Din kiropraktor i skaraborg
            </p>
            <h1 className="font-display text-5xl md:text-7xl leading-[1.05] text-cream">
              ...
              Mindre smärta.
              <br />
              <em className="text-gold not-italic">Ökad livskvalitet.</em>
            </h1>
            <p className="mt-6 text-cream/75 text-lg max-w-lg leading-relaxed">
              Hos Ek Kiropraktik möts du av personligt engagemang och en behandling som är anpassad
              efter just dina behov.
            </p>
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                to="/kontakt"
                className="inline-flex items-center gap-2 bg-cream text-navy px-7 py-3.5 rounded-sm font-medium hover:bg-gold transition-colors"
              >
                Boka tid <ArrowRight size={18} />
              </Link>
              <Link
                to="/tjanster"
                className="inline-flex items-center gap-2 border border-cream/30 text-cream px-7 py-3.5 rounded-sm hover:bg-cream/10 transition-colors"
              >
                Våra tjänster
              </Link>
            </div>
      ...
      <section className="relative py-24 bg-background overflow-hidden">
        <svg
          className="pointer-events-none absolute -right-20 top-20 w-72 h-72 text-navy/5"
          viewBox="0 0 200 200"
          fill="currentColor"
        >
          <path
            d="M40,-65C52,-58,62,-47,69,-34C76,-21,80,-7,77,7C74,21,64,34,53,46C42,58,30,67,16,71C2,75,-13,73,-26,67C-39,61,-50,50,-58,37C-66,24,-71,9,-69,-6C-67,-21,-58,-35,-47,-46C-36,-57,-23,-65,-7,-67C9,-69,28,-72,40,-65Z"
      ...
      <section className="relative py-24 bg-navy text-cream overflow-hidden">
        <svg
          className="pointer-events-none absolute -left-16 -top-16 w-80 h-80 text-cream/5"
          viewBox="0 0 100 100"
          fill="none"
          stroke="currentColor"
          strokeWidth="0.4"
        ...
        <div className="relative mx-auto max-w-5xl px-6">
          ...
          <ul className="divide-y divide-cream/15 border-y border-cream/15">
            {priceList.map((p) => (
              <li key={p.label} className="flex items-baseline justify-between gap-6 py-5">
                ...
                <span className="font-display text-2xl md:text-3xl text-gold whitespace-nowrap">
                  {p.price}
                </span>
              </li>
            ))}
          ...
          <p className="mt-8 text-cream/60 text-sm">
            Medicinsk laser ingår som komplement vid kiropraktik nybesök/återbesök vid behov. Rehab
            ingår i samtliga av våra tjänster och är alltid individanpassad för just dina behov.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <ol className="space-y-6">
              {[
                {
                  t: "Kontakt & tidsbokning",
                  d: "Du hör av dig via telefon eller mail så hittar vi en tid som passar.",
                },
                {
                  t: "Anamnes",
                  d: "Vi tar din berättelse – sjukhistoria, besvär, vardag och målbild.",
                },
                {
                  t: "Behandlingsplan",
                  d: "Tillsammans skapar vi en plan som är anpassad efter just dina behov.",
                },
                {
                  t: "Behandling",
                  d: "Vi behandlar med de metoder som är lämpliga – kiropraktik, massage, laser eller rehab.",
                },
              ].map((step, i) => (
            ...
            {[
              {
                ...
                text: "Rygg, nacke, huvudvärk och ischias – vi hjälper dig identifiera orsaken.",
                to: "/behandling" as const,
                hash: "vanliga-besvar",
              },
              {
                icon: Activity,
                title: "Idrottare",
                text: "Maximera prestationen och minimera skaderisken med riktad behandling.",
                to: "/behandling" as const,
                hash: "idrottare",
              },
              {
                icon: ShieldCheck,
                title: "Förebyggande",
                text: "Regelbunden vård som håller kroppen i balans över tid.",
                to: "/behandling" as const,
                hash: "forebyggande",
              },
            ].map((b) => (
              <Link
                ...
                to={b.to}
                hash={b.hash}
                className="bg-card p-8 border-l-2 border-gold hover:shadow-lg transition-shadow"
              >
        ...
        <div className="relative mx-auto max-w-3xl px-6 text-center text-cream">
          ...
          <div className="mt-8 flex flex-wrap gap-4 justify-center">
            <a
              ...
              className="bg-cream text-navy px-7 py-3.5 rounded-sm font-medium hover:bg-gold transition-colors"
            >
              {clinic.phone.display}
            </a>
            <a
              href={emailHref}
              className="border border-cream/30 text-cream px-7 py-3.5 rounded-sm hover:bg-cream/10 transition-colors"
            >
              {clinic.email}
            </a>
          </div>
